...
class StartScreenFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            registerbutton.setOnClickListener { findNavController().navigate(R.id.action_startScreenFragment_to_registerFragment) }
            alreadyregistered.setOnClickListener { findNavController().navigate(R.id.action_startScreenFragment_to_loginFragment) }
        }
    }
